...
7. Run R code: rpp_version <- c("nltk==3.6.7")
...
NOTE: Steps 7-9 only work for R version [4.3](https://mac.r-project.org/big-sur-arm64/R-4.3-branch/R-4.3-branch-arm64.pkg) at https://mac.r-project.org/ 
