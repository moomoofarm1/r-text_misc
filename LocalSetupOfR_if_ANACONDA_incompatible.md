...
4. Run R code: reticulate::conda_install(envname="textrpp_condaenv", packages=c("torch==2.2.0"), pip=TRUE)
5. Run R code: reticulate::conda_install(envname="textrpp_condaenv", packages=c("NLTK", "transformers==4.19.2", "evaluate","accelerate")) # 4.36.0
